      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <div className="mt-5 flex gap-3">
            <a href="mailto:hello@samaanya.org" className="rounded-full border border-border p-2.5 text-foreground/70 transition-smooth hover:border-accent hover:text-accent" aria-label="Email">
